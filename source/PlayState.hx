...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
            ...
            case 'mousemanstreets': //Week 9
				var bg:BGSprite = new BGSprite('Destruido', -600, -200, 1, 1);
				add(bg);
				var bg:BGSprite = new BGSprite('voidshish', -580, -180, 1, 1);
				add(bg);
	...
	public function updateScore(miss:Bool = false)
	{
		...
		+ ' | Port by HeHe be | Misses: ' + songMisses
		+ ' | Rating: ' + ratingName
